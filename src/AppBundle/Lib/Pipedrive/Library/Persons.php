...
class Persons
{
    ...
    public function deals(array $data)
    {
        ...
        if (!isset($data['id'])) {
            throw new \Exception('You must include the "id" of the person when getting deals');
        }
    ...
    public function products(array $data)
    {
        //if there is no id set throw error as it is a required field
        if (!isset($data['id'])) {
            throw new \Exception('You must include the "id" of the person when getting products');
        }
    ...
    public function add(array $data)
    {
        ...
        if (!isset($data['name'])) {
            throw new \Exception('You must include a "name" field when inserting a person');
        }
