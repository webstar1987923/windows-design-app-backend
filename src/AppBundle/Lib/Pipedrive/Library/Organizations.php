...
class Organizations
{
    ...
    public function deals(array $data)
    {
        ...
        if (!isset($data['id'])) {
            throw new \Exception('You must include the "id" of the organization when getting deals');
        }
    ...
    public function add(array $data)
    {
        //if there is no name set throw error as it is a required field
        if (!isset($data['name'])) {
            throw new \Exception('You must include a "name" field when inserting a organization');
        }
