...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.bcrypt_encoder' => 'getApp_BcryptEncoderService',
            'app.fetch_remote' => 'getApp_FetchRemoteService',
            'app.manager.app_settings' => 'getApp_Manager_AppSettingsService',
            'app.manager.files' => 'getApp_Manager_FilesService',
            'app.manager.project_file' => 'getApp_Manager_ProjectFileService',
            'app.repository.project' => 'getApp_Repository_ProjectService',
            ...
            'doctrine.auditable.listener' => 'getDoctrine_Auditable_ListenerService',
            ...
            'doctrine.timestampable.listener' => 'getDoctrine_Timestampable_ListenerService',
            ...
            'form_errors' => 'getFormErrorsService',
            ...
            'fos_rest.request_matcher.8bbd2d13812def1c8e0250def8f4653f7e909555fb2fb09b04b88d49c48c791dc2d55b71' => 'getFosRest_RequestMatcher_8bbd2d13812def1c8e0250def8f4653f7e909555fb2fb09b04b88d49c48c791dc2d55b71Service',
            ...
            'gaufrette.temp_filesystem' => 'getGaufrette_TempFilesystemService',
            'gedmo.listener.softdeleteable' => 'getGedmo_Listener_SoftdeleteableService',
            'helpers.imagehelper' => 'getHelpers_ImagehelperService',
            'helpers.pdfhelper' => 'getHelpers_PdfhelperService',
            ...
            'security.firewall.map.context.files' => 'getSecurity_Firewall_Map_Context_FilesService',
    ...
    /**
     * Gets the 'app.bcrypt_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Encoder\BCryptPasswordEncoder A AppBundle\Security\Encoder\BCryptPasswordEncoder instance.
     */
    protected function getApp_BcryptEncoderService()
    {
        return $this->services['app.bcrypt_encoder'] = new \AppBundle\Security\Encoder\BCryptPasswordEncoder(13);
    }

    /**
     * Gets the 'app.fetch_remote' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Lib\FetchRemote A AppBundle\Lib\FetchRemote instance.
     */
    protected function getApp_FetchRemoteService()
    {
        return $this->services['app.fetch_remote'] = new \AppBundle\Lib\FetchRemote();
    }

    /**
     * Gets the 'app.manager.app_settings' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\AppSettingsManager A AppBundle\Manager\AppSettingsManager instance.
     */
    protected function getApp_Manager_AppSettingsService()
    {
        return $this->services['app.manager.app_settings'] = new \AppBundle\Manager\AppSettingsManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.manager.files' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\FilesManager A AppBundle\Manager\FilesManager instance.
     */
    protected function getApp_Manager_FilesService()
    {
        $this->services['app.manager.files'] = $instance = new \AppBundle\Manager\FilesManager(new \GuzzleHttp\Client());
    ...
    /**
     * Gets the 'app.manager.project_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\ProjectFileManager A AppBundle\Manager\ProjectFileManager instance.
     */
    protected function getApp_Manager_ProjectFileService()
    {
        return $this->services['app.manager.project_file'] = new \AppBundle\Manager\ProjectFileManager($this->get('app.manager.files'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.repository.project' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'app.repository.project' service is requested while the 'request' scope is not active
     */
    protected function getApp_Repository_ProjectService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('app.repository.project', 'request');
        }

        $this->services['app.repository.project'] = $this->scopedServices['request']['app.repository.project'] = $instance = $this->get('doctrine')->getRepository('AppBundle:Project');
    ...
    /**
     * Gets the 'doctrine.auditable.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Listener\AuditableListener A AppBundle\Listener\AuditableListener instance.
     */
    protected function getDoctrine_Auditable_ListenerService()
    {
        return $this->services['doctrine.auditable.listener'] = new \AppBundle\Listener\AuditableListener($this->get('security.token_storage'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist'), $this->get('doctrine.auditable.listener'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        $c->addEventListener(array(0 => 'prePersist'), $this->get('doctrine.timestampable.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'prossimo', 'user' => 'postgres', 'password' => 12345678, 'sslmode' => 'allow', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the 'doctrine.timestampable.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Listener\TimestampableListener A AppBundle\Listener\TimestampableListener instance.
     */
    protected function getDoctrine_Timestampable_ListenerService()
    {
        return $this->services['doctrine.timestampable.listener'] = new \AppBundle\Listener\TimestampableListener();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_67e286192719c7c741169cacd9e98519374c9990c9820cf4321bf16a235e7fd0');
    ...
    /**
     * Gets the 'form_errors' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\FormErrors A AppBundle\Form\FormErrors instance.
     */
    protected function getFormErrorsService()
    {
        return $this->services['form_errors'] = new \AppBundle\Form\FormErrors();
    }
    ...
    protected function getFosRest_ExceptionFormatNegotiatorService()
    {
        ...
        $instance->add($this->get('fos_rest.request_matcher.8bbd2d13812def1c8e0250def8f4653f7e909555fb2fb09b04b88d49c48c791dc2d55b71'), array('priorities' => array(0 => '*/*'), 'methods' => NULL, 'stop' => false, 'prefer_extension' => '2.0', 'fallback_format' => 'html'));
    ...
    {
        return $this->services['fos_user.user_provider.username'] = new \AppBundle\Security\UserProvider($this->get('fos_user.user_manager'));
    }
    ...
    {
        return $this->services['gaufrette.local_filesystem'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local(($this->targetDirs[2].'/../../prossimo-files/files'), true));
    }

    /**
     * Gets the 'gaufrette.temp_filesystem' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Gaufrette\Filesystem A Gaufrette\Filesystem instance.
     */
    protected function getGaufrette_TempFilesystemService()
    {
        return $this->services['gaufrette.temp_filesystem'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local(($this->targetDirs[2].'/../../prossimo-files/temp'), true));
    }
    ...
    /**
     * Gets the 'helpers.imagehelper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Helpers\ImageHelper A AppBundle\Helpers\ImageHelper instance.
     */
    protected function getHelpers_ImagehelperService()
    {
        return $this->services['helpers.imagehelper'] = new \AppBundle\Helpers\ImageHelper();
    }

    /**
     * Gets the 'helpers.pdfhelper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Helpers\PDFHelper A AppBundle\Helpers\PDFHelper instance.
     */
    protected function getHelpers_PdfhelperService()
    {
        return $this->services['helpers.pdfhelper'] = new \AppBundle\Helpers\PDFHelper();
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[2].'/Resources/FOSUserBundle/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\MigrationsBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-migrations-bundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Lexik/Bundle/JWTAuthenticationBundle/Resources/config/serializer'), 'Knp\\Bundle\\GaufretteBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-gaufrette-bundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'/vendor/stof/doctrine-extensions-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['knp_gaufrette.filesystem_map'] = new \Knp\Bundle\GaufretteBundle\FilesystemMap(array('local' => $this->get('gaufrette.local_filesystem'), 'temp' => $this->get('gaufrette.temp_filesystem')));
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.openssl_key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\OpenSSLKeyLoader(($this->targetDirs[2].'/var/jwt/private.pem'), ($this->targetDirs[2].'/var/jwt/public.pem'), 'rootroot');
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'POST', 5 => 'PUT', 6 => 'GET', 7 => 'DELETE'), 'expose_headers' => array(0 => 'Location', 1 => 'Location'))), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 3600, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\User' => $this->get('app.bcrypt_encoder')));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.register' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/register'), 'security.firewall.map.context.files' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/files/.*/(download|thumbnail)$'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.files' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_FilesService()
    {
        return $this->services['security.firewall.map.context.files'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h->setOptions(array('default_target_path' => '/admin', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58d3e5af9ba7f3.32643603', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('api_base_path', '/api');
    ...
    /**
     * Gets the 'fos_rest.request_matcher.8bbd2d13812def1c8e0250def8f4653f7e909555fb2fb09b04b88d49c48c791dc2d55b71' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Symfony\Component\HttpFoundation\RequestMatcher A Symfony\Component\HttpFoundation\RequestMatcher instance.
     */
    protected function getFosRest_RequestMatcher_8bbd2d13812def1c8e0250def8f4653f7e909555fb2fb09b04b88d49c48c791dc2d55b71Service()
    {
        return $this->services['fos_rest.request_matcher.8bbd2d13812def1c8e0250def8f4653f7e909555fb2fb09b04b88d49c48c791dc2d55b71'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/files/.*/download$', NULL, NULL);
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/files'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'login', $d, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58d3e5af9ba7f3.32643603'), 2 => $e, 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'main', $d, true), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58d3e5af9ba7f3.32643603')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_MANAGER' => array(0 => 'ROLE_USER'), 'ROLE_API' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jwt_key_pass_phrase' => 'rootroot',
            'jwt_token_ttl' => 86400,
            'pdf_data_path' => ($this->targetDirs[2].'/../web/data/pdf'),
            'pdf_data_url' => '/data/pdf',
            'prossimo_server_files_temp_directory' => ($this->targetDirs[2].'/../../prossimo-files/temp'),
            'prossimo_server_files_directory' => ($this->targetDirs[2].'/../../prossimo-files/files'),
            ...
            'lexik_jwt_authentication.pass_phrase' => 'rootroot',
